    ...
    while settings.gameover:
        ...
        while game.rungame:
            ...
            # Game
                ...
                # Break While Loop if Quitting before the rest of the loop runs (Using before because was
                # pygame.quit() in quit loop
                if not game.rungame:
                    break
                ...
                # Arrow Keys Drawn
                a = pygame.image.load("assets/arrow.png")
                arrow1 = menu.Button(a, (width / 1.2, height / 1.2 - 80), "", pygame.font.Font("font.ttf", 50), "White", "Red")

                b = pygame.transform.rotate(a, -90)
                arrow2 = menu.Button(b, (width / 1.2 + 80, height / 1.2), "", pygame.font.Font("font.ttf", 50), "White", "Red")

                c = pygame.transform.rotate(a, 90)
                arrow3 = menu.Button(c, (width / 1.2 - 80, height / 1.2), "", pygame.font.Font("font.ttf", 50), "White", "Red")

                d = pygame.transform.rotate(a, 180)
                arrow4 = menu.Button(d, (width / 1.2, height / 1.2 + 80), "", pygame.font.Font("font.ttf", 50), "White", "Red")

                arrow1.update(game.screen)
                arrow2.update(game.screen)
                arrow3.update(game.screen)
                arrow4.update(game.screen)
