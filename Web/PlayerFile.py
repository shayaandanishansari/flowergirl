...
class Player(Entity):
    ...
    def player_rotation(self):
        ...
        self.angles = degrees(atan2((self.mouse[1] - height / 2), (self.mouse[0] - width / 2)))
    ...
    def input(self):
        ...
        if pygame.mouse.get_pressed() == (1, 0, 0):
            ...
            if self.bullet != None:
                pass
                # self.bullet.collision(self.obstacle_sprites)
                # self.bullet.collisione(self.enemy_sprites)
            if settings.phone:
